(function () {
  ...
  const regions = {
    ...
    AT: { label: "Austria", locale: "de-AT", currency: "EUR" },
    BD: { label: "Bangladesh", locale: "en-BD", currency: "BDT" },
    BE: { label: "Belgium", locale: "nl-BE", currency: "EUR" },
    NZ: { label: "New Zealand", locale: "en-NZ", currency: "NZD" },

    CL: { label: "Chile", locale: "es-CL", currency: "CLP" },
    DK: { label: "Denmark", locale: "da-DK", currency: "DKK" },
    ...
    OM: { label: "Oman", locale: "en-OM", currency: "OMR" },
    QA: { label: "Qatar", locale: "en-QA", currency: "QAR" },
    ...
    FI: { label: "Finland", locale: "fi-FI", currency: "EUR" },
    IE: { label: "Ireland", locale: "en-IE", currency: "EUR" },
    NL: { label: "Netherlands", locale: "nl-NL", currency: "EUR" },
    NO: { label: "Norway", locale: "nb-NO", currency: "NOK" },
    PL: { label: "Poland", locale: "pl-PL", currency: "PLN" },
    PT: { label: "Portugal", locale: "pt-PT", currency: "EUR" },
    SE: { label: "Sweden", locale: "sv-SE", currency: "SEK" },
  ...
  const currencies = {
    ...
    BDT: { label: "Bangladeshi Taka", symbol: "৳", currencyDisplay: "narrowSymbol" },
    ...
    OMR: { label: "Omani Rial", symbol: "OMR" },
    QAR: { label: "Qatari Riyal", symbol: "QAR" },
